<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ url('/profile/' . Auth::user()->user_id) }}" class="nav-link {{ $active_menu == 'profile' ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ url('/supplier') }}"
                class="nav-link {{ $active_menu == 'supplier' ? 'active' : '' }} ">
            ...
            {{-- <li class="nav-item">
                <a href="{{ url('/barang') }}"
                    class="nav-link {{ $active_menu == 'penjualan' ? 'active' : '' }} ">
