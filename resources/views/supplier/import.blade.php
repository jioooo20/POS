            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" name="file_supplier" id="file_supplier" class="custom-file-input" required>
                        <label class="custom-file-label" for="file_supplier">Pilih berkas...</label>
                    </div>
                    <small id="error-file_supplier" class="error-text form-text text-danger mt-1"></small>
                </div>
            </div>
...
<script>
    document.getElementById('file_supplier').addEventListener('change', function(e) {
