    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="file_user" class="font-weight-bold">Pilih File</label>
                    <div class="custom-file">
                        <input type="file" name="file_user" id="file_user" class="custom-file-input" required>
                        <label class="custom-file-label" for="file_user">Pilih berkas...</label>
                    </div>
                    <small id="error-file_user" class="error-text form-text text-danger mt-1"></small>
                </div>
            </div>
